...
@section('title', 'Edit Medical Service - ' . $service->title)
@section('header_title', 'Edit Medical Service & Detail Page')
...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        ...
        <div class="d-flex gap-2">
            <a href="{{ url('/services/' . $service->slug) }}" target="_blank" class="btn btn-light text-primary border shadow-sm">
                <i class="fa-solid fa-arrow-up-right-from-square mr-5"></i> Live View on Website
            </a>
        </div>
    </div>
    ...
    <form action="{{ route('admin.services.update', $service->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="admin-card mb-4">
            <div class="admin-card-header d-flex align-items-center justify-content-between">
                ...
                <span class="badge bg-primary-subtle text-primary px-3 py-1">Slug: /services/{{ $service->slug }}</span>
            </div>
            <div class="admin-card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="category" class="form-control form-control-lg" value="{{ old('category', $service->category) }}" placeholder="e.g. ICU & Critical Care, Diagnostics" required>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label font-weight-bold">Medical Icon (Flaticon / FontAwesome)</label>
                        <input type="text" name="icon" list="flaticon_list" class="form-control" value="{{ old('icon', $service->icon) }}">
                        ...
                        <small class="text-muted">Current Icon: <i class="{{ $service->icon }} text-primary"></i> <code>{{ $service->icon }}</code></small>
                    </div>
                    ...
                    <div class="col-md-2 d-flex align-items-center pt-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" name="is_featured" value="1" id="is_featured" {{ $service->is_featured ? 'checked' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($service->image)
                            <div class="mb-2 p-2 bg-light border rounded d-inline-block">
                                <img src="{{ asset($service->image) }}" alt="Preview" class="rounded shadow-sm" style="height: 100px; object-fit: cover;">
                            </div>
                        @endif
                    ...
                    <div class="col-md-6">
                        ...
                        @if($service->image_2)
                            <div class="mb-2 p-2 bg-light border rounded d-inline-block">
                                <img src="{{ asset($service->image_2) }}" alt="Preview 2" class="rounded shadow-sm" style="height: 100px; object-fit: cover;">
                            </div>
                        @endif
            ...
            <div class="admin-card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="process_title" class="form-control" value="{{ old('process_title', $service->process_title) }}" placeholder="e.g. {{ $service->title }} Overview & Specs">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="banner_subtitle" class="form-control" value="{{ old('banner_subtitle', $service->banner_subtitle) }}" placeholder="e.g. Advanced Biomedical Diagnostic Systems">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="features" class="form-control" rows="5" placeholder="Enter each key bullet point on a new line...">{{ old('features', $service->features) }}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($service->banner_image)
                            <div class="mb-2 p-2 bg-light border rounded d-inline-block">
                                <img src="{{ asset($service->banner_image) }}" alt="Banner Preview" class="rounded shadow-sm" style="height: 70px; object-fit: cover;">
                            </div>
                        @endif
            ...
            <div class="admin-card-body">
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="steps_title" class="form-control" value="{{ old('steps_title', $service->steps_title ?: '4 Simple Steps') }}">
                    </div>
                    <div class="col-md-12">
                        <label class="form-label font-weight-bold">Steps Section Description</label>
                        <textarea name="steps_description" class="form-control" rows="3">{{ old('steps_description', $service->steps_description) }}</textarea>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="p-3 border rounded bg-light h-100">
                            ...
                            <input type="text" name="step_1_title" class="form-control mb-2" value="{{ old('step_1_title', $service->step_1_title ?: 'Step 01') }}">
                            <label class="form-label small font-weight-bold">Bullet Points (1 per line)</label>
                            <textarea name="step_1_points" class="form-control" rows="4">{{ old('step_1_points', $service->step_1_points) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="p-3 border rounded bg-light h-100">
                            ...
                            <input type="text" name="step_2_title" class="form-control mb-2" value="{{ old('step_2_title', $service->step_2_title ?: 'Step 02') }}">
                            <label class="form-label small font-weight-bold">Bullet Points (1 per line)</label>
                            <textarea name="step_2_points" class="form-control" rows="4">{{ old('step_2_points', $service->step_2_points) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="p-3 border rounded bg-light h-100">
                            ...
                            <input type="text" name="step_3_title" class="form-control mb-2" value="{{ old('step_3_title', $service->step_3_title ?: 'Step 03') }}">
                            <label class="form-label small font-weight-bold">Bullet Points (1 per line)</label>
                            <textarea name="step_3_points" class="form-control" rows="4">{{ old('step_3_points', $service->step_3_points) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="p-3 border rounded bg-light h-100">
                            ...
                            <input type="text" name="step_4_title" class="form-control mb-2" value="{{ old('step_4_title', $service->step_4_title ?: 'Step 04') }}">
                            <label class="form-label small font-weight-bold">Bullet Points (1 per line)</label>
                            <textarea name="step_4_points" class="form-control" rows="4">{{ old('step_4_points', $service->step_4_points) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-card-body">
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="research_title" class="form-control" value="{{ old('research_title', $service->research_title ?: 'Our Research & Clinical Verification') }}">
                    </div>

                    <div class="col-12">
                        <label class="form-label font-weight-bold">Research Description</label>
                        <textarea name="research_description" class="form-control" rows="3">{{ old('research_description', $service->research_description) }}</textarea>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label font-weight-bold">Showcase Wide Banner Image</label>
                        @if($service->research_image)
                            <div class="mb-2 p-2 bg-light border rounded d-inline-block">
                                <img src="{{ asset($service->research_image) }}" alt="Showcase Preview" class="rounded shadow-sm" style="height: 100px; object-fit: cover;">
                            </div>
                        @endif
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="bottom_link_text" class="form-control" value="{{ old('bottom_link_text', $service->bottom_link_text ?: 'Inquire About This Service') }}">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label font-weight-bold">Bottom CTA Link URL</label>
                        <input type="text" name="bottom_link_url" class="form-control" value="{{ old('bottom_link_url', $service->bottom_link_url ?: '/contact') }}">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center p-3 bg-white border rounded shadow-sm sticky-bottom mb-5">
            <div class="text-muted small">
                <i class="fa-solid fa-clock-rotate-left me-1"></i> Last updated: {{ $service->updated_at ? $service->updated_at->format('M d, Y - h:i A') : 'N/A' }}
            </div>
            <div class="d-flex gap-2">
                ...
                <button type="submit" class="btn btn-theme px-5 py-2 fs-6 shadow">
                    <i class="fa-solid fa-floppy-disk mr-5"></i> Update Service & Detail Page
                </button>
            </div>
        </div>
    </form>
